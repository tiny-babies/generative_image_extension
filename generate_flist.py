...
parser.add_argument('--validation_filename', default='./data/places2/validation_static_view.flist', type=str,
                    help='The output filename.')
...
if __name__ == "__main__":
    ...
    for dir_item in dirs:
        ...
        for training_item in training_folder:
            ...
            if(index < 800):
                ...
                validation_item = dir_item + "/" + training_item
    ...
    # make output file if not existed - errors so instead, make them manually first
